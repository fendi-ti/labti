              ...
              <div class="card-body">
                 <form class="col-md" action="" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                      ...
                      <input type="text" name="nim" id="inputnim" class="form-control" placeholder="NIM" required autofocus>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-row">
                      ...
                      <div class="form-group col-md">
                        ...
                        <input type="password" name="password2" id="inputpasscon" class="form-control" placeholder="Password-Confirm" required autofocus>
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <label for="inputfile">Upload Formulir Pendaftaran</label>
                      <input type="file" name="formulir" id="inputfile">
                    </div>
                    <!--<div class="custom-file">
                                <input type="file" name="formulir" class="custom-file-input" id="inputfile">
                                <label class="custom-file-label" for="inputfile">Upload Formulir Pendaftaran</label>
                            </div>-->
                    <div class="form-group">
                      <div class="g-recaptcha" data-sitekey="6LdH6K4ZAAAAAKqRnksrx9Y-3jCXamanW9_PVdgD"></div>

                    </div>
                    <button class="btn btn-lg btn-success" type="submit" name="register">DAFTAR</button>
