                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title"> Form Transaksi Keluar Masuk Barang</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                            ...
                            <form method="post" action="{{ route('addtrans') }}">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <select name="tipe" class="form-control" aria-label="Default select example">
                                ...
                                <div class="card-footer">
                                    ...
                                    <a class="btn btn-secondary" href="{{url('/historytrans')}}" role="button">Kembali</a>
                                </div>
                            </form>
                        </div>
                    </div>
